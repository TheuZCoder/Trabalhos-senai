    ...
    public static void main(String[] args) {
        ...
        while (calcular) {
            try {
                ...
                int acao = JOptionPane.showOptionDialog(null, "Escolha a Operação", "Calculadora", JOptionPane.DEFAULT_OPTION, JOptionPane.CANCEL_OPTION, null, operacao, operacao[0]);
                if(acao==0){
                ...
                JOptionPane.showMessageDialog(null, "Erro - valor não pode dividir por 0");
            }
